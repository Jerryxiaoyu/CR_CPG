...
from oscillator_2_1_eval import oscillator_nw
...
FLT_MIN_GAIN0, FLT_MAX_GAIN0 = -2, 2
FLT_MIN_GAIN1, FLT_MAX_GAIN1 =  -2, 2
FLT_MIN_GAIN2, FLT_MAX_GAIN2 =  -2, 2
FLT_MIN_GAIN3, FLT_MAX_GAIN3 =  -2, 2
FLT_MIN_GAIN4, FLT_MAX_GAIN4 =  -2, 2
FLT_MIN_GAIN5, FLT_MAX_GAIN5 =  -2, 2
FLT_MIN_GAIN6, FLT_MAX_GAIN6 = -2, 2
FLT_MIN_GAIN7, FLT_MAX_GAIN7 =  -2, 2
FLT_MIN_GAIN8, FLT_MAX_GAIN8 =  -2, 2
FLT_MIN_GAIN9, FLT_MAX_GAIN9 =  -2, 2
FLT_MIN_GAIN10, FLT_MAX_GAIN10 =  -2, 2
FLT_MIN_GAIN11, FLT_MAX_GAIN11 =  -2, 2
FLT_MIN_GAIN12, FLT_MAX_GAIN12 =  -2, 2
...
FLT_MIN_BIAS9, FLT_MAX_BIAS9 = -math.radians(90), math.radians(90)
FLT_MIN_BIAS10, FLT_MAX_BIAS10 = -math.radians(90), math.radians(90)
FLT_MIN_BIAS11, FLT_MAX_BIAS11 = -math.radians(90), math.radians(90)
FLT_MIN_BIAS12, FLT_MAX_BIAS12 = -math.radians(90), math.radians(90)
...
log.info('[GA] FLT_MIN_BIAS9={0}, FLT_MAX_BIAS9={1}'.format(FLT_MIN_BIAS9, FLT_MAX_BIAS9))
log.info('[GA] FLT_MIN_BIAS10={0}, FLT_MAX_BIAS10={1}'.format(FLT_MIN_BIAS10, FLT_MAX_BIAS10))
log.info('[GA] FLT_MIN_BIAS11={0}, FLT_MAX_BIAS11={1}'.format(FLT_MIN_BIAS11, FLT_MAX_BIAS11))
log.info('[GA] FLT_MIN_BIAS12={0}, FLT_MAX_BIAS12={1}'.format(FLT_MIN_BIAS12, FLT_MAX_BIAS12))
...
toolbox.register("bias9_flt", random.uniform, FLT_MIN_BIAS9, FLT_MAX_BIAS9)
toolbox.register("bias10_flt", random.uniform, FLT_MIN_BIAS10, FLT_MAX_BIAS10)
toolbox.register("bias11_flt", random.uniform, FLT_MIN_BIAS11, FLT_MAX_BIAS11)
toolbox.register("bias12_flt", random.uniform, FLT_MIN_BIAS12, FLT_MAX_BIAS12)
...
toolbox.register("individual", tools.initCycle, creator.Individual,
                 (toolbox.kf_flt,toolbox.gain0_flt,
                  ...
                  toolbox.gain10_flt, toolbox.gain11_flt, toolbox.gain12_flt,toolbox.bias0_flt ,
                  ...
                  toolbox.bias9_flt ,toolbox.bias10_flt, toolbox.bias11_flt, toolbox.bias12_flt,
                  ),
                 n=N_CYCLES)
