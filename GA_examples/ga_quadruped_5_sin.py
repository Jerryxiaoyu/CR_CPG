...
parser.add_argument('--env_name', type=str, default='Cellrobot2Env-v0')  #  Ant2-v2  HalfCheetah-v2  ArmReacherEnv-v0  Hopper2-v2: Swimmer2-v2
...
toolbox.register("individual", tools.initCycle, creator.Individual,
                 (toolbox.kf_flt,toolbox.gain0_flt,
                  ...
                  toolbox.phase6_flt,toolbox.phase7_flt,toolbox.phase8_flt,
                    toolbox.phase9_flt,toolbox.phase10_flt,toolbox.phase11_flt, toolbox.phase12_flt,
