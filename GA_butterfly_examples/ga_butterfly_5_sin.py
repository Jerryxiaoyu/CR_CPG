...
parser.add_argument('--env_name', type=str, default='CellrobotButterflyEnv-v0')  #  Ant2-v2  HalfCheetah-v2  ArmReacherEnv-v0  Hopper2-v2: Swimmer2-v2
...
log_name = 'butter_GA5_weight_sin'
CPG_parm_num = 7
...
toolbox.register("individual", tools.initCycle, creator.Individual,
                 (toolbox.kf_flt,toolbox.gain0_flt,
                  ...
                  toolbox.bias5_flt ,toolbox.bias6_flt,
