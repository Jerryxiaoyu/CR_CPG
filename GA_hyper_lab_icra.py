...
class VG(VariantGenerator):
    ...
    @variant
    def env_name(self):
        return ['CellrobotEnv-v0', 'CellrobotBigdog2Env-v0','CellrobotButterflyEnv-v0' ]  #   'CellrobotEnv-v0' , 'Cellrobot2Env-v0', 'CellrobotSnakeEnv-v0'  , 'CellrobotSnake2Env-v0','CellrobotButterflyEnv-v0', 'CellrobotBigdog2Env-v0'
    @variant
    def pop_size(self):
        return [300]
